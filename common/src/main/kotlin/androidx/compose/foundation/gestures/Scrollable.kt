 ...
 */
internal fun platformScrollableDefaultFlingBehavior(): ScrollableDefaultFlingBehavior =
    object : ScrollableDefaultFlingBehavior {
        // Minecraft 平台第一版:不做惯性滚动,直接返回剩余速度
 ...
 * behavior.
 */
@Composable internal fun rememberPlatformDefaultFlingBehavior(): FlingBehavior = platformScrollableDefaultFlingBehavior()
