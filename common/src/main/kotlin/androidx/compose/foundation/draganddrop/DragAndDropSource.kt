...
@Immutable
internal object DragAndDropSourceDefaults {
    /**
...
internal class CacheDrawScopeDragShadowCallback() {
    fun drawDragShadow(drawScope: DrawScope) = Unit

    // Minecraft 平台第一版:拖拽阴影不做离屏缓存
    fun cachePicture(scope: CacheDrawScope): DrawResult = DrawResult { }
}
