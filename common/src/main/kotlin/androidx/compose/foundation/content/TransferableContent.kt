 ...
 */
@ExperimentalFoundationApi class PlatformTransferableContent

/** Returns whether this [TransferableContent] can provide an item with the [mediaType]. */
@ExperimentalFoundationApi
fun TransferableContent.hasMediaType(mediaType: MediaType): Boolean = false
 ...
 */
internal fun ClipEntry.readPlainText(): String? = text
