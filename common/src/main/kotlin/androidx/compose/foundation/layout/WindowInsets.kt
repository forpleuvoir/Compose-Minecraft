...
private class UnionInsets(private val first: WindowInsets, private val second: WindowInsets) :
    ...
    override fun toString(): String = "($first 鈭?$second)"
}
...
val WindowInsets.Companion.captionBar: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/** This [WindowInsets] represents the area with the display cutout (e.g. for camera). */
val WindowInsets.Companion.displayCutout: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/** An insets type representing the window of the software keyboard. */
val WindowInsets.Companion.ime: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/**
 * These insets represent the space where system gestures have priority over application gestures.
 */
val WindowInsets.Companion.mandatorySystemGestures: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/**
 * These insets represent where system UI places navigation bars. Interactive UI should avoid the
 * navigation bars area.
 */
val WindowInsets.Companion.navigationBars: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/** These insets represent status bar. */
val WindowInsets.Companion.statusBars: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/**
 * These insets represent all system bars. Includes [statusBars], [captionBar] as well as
 * [navigationBars], but not [ime].
 */
val WindowInsets.Companion.systemBars: WindowInsets get() = WindowInsets(0, 0, 0, 0)
 ...
 */
val WindowInsets.Companion.systemGestures: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/** Returns the tappable element insets. */
val WindowInsets.Companion.tappableElement: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/** The insets for the curved areas in a waterfall display. */
val WindowInsets.Companion.waterfall: WindowInsets get() = WindowInsets(0, 0, 0, 0)

/** The path for the cutout, if any. */
val WindowInsets.Companion.cutoutPath: Path? get() = null
 ...
 */
val WindowInsets.Companion.safeDrawing: WindowInsets get() = WindowInsets(0, 0, 0, 0)
 ...
 */
val WindowInsets.Companion.safeGestures: WindowInsets get() = WindowInsets(0, 0, 0, 0)
 ...
 */
val WindowInsets.Companion.safeContent: WindowInsets get() = WindowInsets(0, 0, 0, 0)
