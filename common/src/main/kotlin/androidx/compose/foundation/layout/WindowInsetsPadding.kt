 ...
 */
fun Modifier.safeDrawingPadding(): Modifier = this.windowInsetsPadding(WindowInsets.safeDrawing)
 ...
 */
fun Modifier.safeGesturesPadding(): Modifier = this.windowInsetsPadding(WindowInsets.safeGestures)
 ...
 */
fun Modifier.safeContentPadding(): Modifier = this.windowInsetsPadding(WindowInsets.safeContent)
 ...
 */
fun Modifier.displayCutoutPadding(): Modifier = this.windowInsetsPadding(WindowInsets.displayCutout)
 ...
 */
fun Modifier.statusBarsPadding(): Modifier = this.windowInsetsPadding(WindowInsets.statusBars)
 ...
 */
fun Modifier.imePadding(): Modifier = this.windowInsetsPadding(WindowInsets.ime)
 ...
 * @sample androidx.compose.foundation.layout.samples.statusBarsAndNavigationBarsPaddingSample
 */
fun Modifier.navigationBarsPadding(): Modifier = this.windowInsetsPadding(WindowInsets.navigationBars)
 ...
 */
fun Modifier.captionBarPadding(): Modifier = this.windowInsetsPadding(WindowInsets.captionBar)
 ...
 */
fun Modifier.waterfallPadding(): Modifier = this.windowInsetsPadding(WindowInsets.waterfall)
 ...
 */
fun Modifier.systemGesturesPadding(): Modifier = this.windowInsetsPadding(WindowInsets.systemGestures)
 ...
 */
fun Modifier.mandatorySystemGesturesPadding(): Modifier = this.windowInsetsPadding(WindowInsets.mandatorySystemGestures)
