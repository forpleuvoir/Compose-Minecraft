...
// 平台适配点:官方 Modifier.shadow(androidx.compose.ui.draw)已弃用并重定向到
...
@Composable internal fun computeContextMenuColors(): ContextMenuColors = ContextMenuColors(
    backgroundColor = Color(0xFF2B2B2B),
    textColor = Color.White,
    iconColor = Color.White,
    disabledTextColor = Color(0xFF808080),
    disabledIconColor = Color(0xFF808080)
)
