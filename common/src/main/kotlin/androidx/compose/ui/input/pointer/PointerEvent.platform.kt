...
internal typealias NativePointerButtons = Int
internal typealias NativePointerKeyboardModifiers = Int
...
internal fun EmptyPointerKeyboardModifiers() = PointerKeyboardModifiers()

/**
 * Describes a pointer input change event that has occurred at a particular point in time.
 */
@OptIn(ExperimentalComposeUiApi::class)
class PointerEvent internal constructor(
    /**
     * The changes.
     */
     ...
     */
    constructor(changes: List<PointerInputChange>) : this(
        changes = changes,
    ...
    var type: PointerEventType = type
        internal set
...
val PointerButtons.isPrimaryPressed
...
fun PointerButtons.indexOfFirstPressed(): Int = when {
    isPrimaryPressed -> 0
...
fun PointerButtons.indexOfLastPressed(): Int = when {
    isForwardPressed -> 4
    isBackPressed -> 3
    isTertiaryPressed -> 2
    isSecondaryPressed -> 1
