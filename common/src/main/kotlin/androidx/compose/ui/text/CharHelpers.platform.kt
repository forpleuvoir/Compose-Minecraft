 ...
 * See https://www.unicode.org/reports/tr9/
 */
internal fun CodePoint.strongDirectionType(): StrongDirectionType =
    when (Character.getDirectionality(this)) {
        Character.DIRECTIONALITY_LEFT_TO_RIGHT -> StrongDirectionType.Ltr

        Character.DIRECTIONALITY_RIGHT_TO_LEFT,
        Character.DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC -> StrongDirectionType.Rtl

        else -> StrongDirectionType.None
    }

internal fun CodePoint.isNeutralDirection(): Boolean =
    when (Character.getDirectionality(this)) {
        Character.DIRECTIONALITY_OTHER_NEUTRALS,
        Character.DIRECTIONALITY_WHITESPACE,
        Character.DIRECTIONALITY_BOUNDARY_NEUTRAL -> true

        else -> false
    }

internal fun CodePoint.isNonSpacingMark(): Boolean =
    Character.getDirectionality(this) == Character.DIRECTIONALITY_NONSPACING_MARK
