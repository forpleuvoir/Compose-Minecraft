...
internal object PlatformHapticFeedbackType {
    val Confirm = HapticFeedbackType(0)
    val ContextClick = HapticFeedbackType(1)
    val GestureEnd = HapticFeedbackType(2)
    val GestureThresholdActivate = HapticFeedbackType(3)
    val KeyboardTap = HapticFeedbackType(4)
    val LongPress = HapticFeedbackType(5)
    val Reject = HapticFeedbackType(6)
    val SegmentFrequentTick = HapticFeedbackType(7)
    val SegmentTick = HapticFeedbackType(8)
    val TextHandleMove = HapticFeedbackType(9)
    val ToggleOn = HapticFeedbackType(10)
    val ToggleOff = HapticFeedbackType(11)
    val VirtualKey = HapticFeedbackType(12)
}
