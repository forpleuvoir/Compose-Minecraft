...
internal fun actualTintColorFilter(color: Color, blendMode: BlendMode): NativeColorFilter =
    NativeColorFilter(color = color, blendMode = blendMode)

internal fun actualColorMatrixColorFilter(colorMatrix: ColorMatrix): NativeColorFilter =
