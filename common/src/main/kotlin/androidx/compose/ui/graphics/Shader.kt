 ...
 */
internal class TransformShader() {
...
internal fun ActualLinearGradientShader(
    from: Offset,
    to: Offset,
    colors: List<Color>,
...
internal fun ActualRadialGradientShader(
    center: Offset,
    radius: Float,
    colors: List<Color>,
    colorStops: List<Float>?,
...
internal fun ActualSweepGradientShader(
    center: Offset,
    colors: List<Color>,
    colorStops: List<Float>?,
...
internal fun ActualImageShader(
    image: ImageBitmap,
    tileModeX: TileMode,
    tileModeY: TileMode,
