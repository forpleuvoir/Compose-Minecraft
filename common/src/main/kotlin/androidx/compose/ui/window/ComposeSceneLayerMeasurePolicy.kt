...
/**
 * Minecraft 平台适配点:与官方 CMP skiko 实现一致 —— 将 [PlatformInsets] 与
 * `usePlatformDefaultWidth`(对话框平台默认宽度)应用到内容测量,并按
 * [calculatePosition] 计算图层在窗口中的绘制位置。
 */
...
private fun Density.preferredDialogWidth(constraints: Constraints): Int {
    ...
    return when {
        smallestWidth >= 600.dp -> 976.dp
        smallestWidth >= 480.dp -> 736.dp
        else -> 528.dp
    }.roundToPx()
}